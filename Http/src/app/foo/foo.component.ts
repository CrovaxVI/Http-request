...
makeRequest(): void {
  ...
  //Notifichiamo che stiamo attendendo dei dati
    console.log("here")
     ...
     this.o = this.http.get('https://jsonplaceholder.typicode.com/posts/1');//Attacchiamo all'Observable o un metodo "observer" che verrà lanciato quando arriva la risposta
